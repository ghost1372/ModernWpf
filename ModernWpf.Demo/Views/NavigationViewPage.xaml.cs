...
namespace ModernWpf.Demo.Views
{
    ...
    public partial class NavigationViewPage : UserControl
    {
        ...
        public static bool CameFromGridChange;
        ...
        private void NavigationView_SelectionChanged2(NavigationView sender,
            NavigationViewSelectionChangedEventArgs args)
        {
        ...
        private void NavigationView_SelectionChanged4(NavigationView sender,
            NavigationViewSelectionChangedEventArgs args)
        {
            if (args.IsSettingsSelected)
            {
        ...
        private void NavigationView_SelectionChanged6(NavigationView sender,
            NavigationViewSelectionChangedEventArgs args)
        {
            if (args.IsSettingsSelected)
            {
        ...
        private void NavigationView_SelectionChanged8(NavigationView sender,
            NavigationViewSelectionChangedEventArgs args)
        {
            ...
            var sampleNum = sender.Name.Substring(8);
