...
using PersianCalendar = ModernWpf.PersianCalendar;
...
namespace Microsoft.Windows.Automation.Peers
{
    ...
    internal sealed class CalendarAutomationPeer : FrameworkElementAutomationPeer, IGridProvider, IMultipleViewProvider, ISelectionProvider, ITableProvider
    {
        ...
        public CalendarAutomationPeer(ModernWpf.PersianCalendar owner)
            : base(owner)
        {
        }
        ...
        private ModernWpf.PersianCalendar OwningCalendar => Owner as ModernWpf.PersianCalendar;
