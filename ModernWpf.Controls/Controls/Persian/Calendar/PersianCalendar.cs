    ...
    public class PersianCalendar : Control
    {
        ...
        internal DateTime DisplayYear
        {
            get
            {
                ...
                return DateTimeHelper.DiscardMonthDayTime(DisplayDate);
            }
        }
        ...
        internal void OnCalendarButtonPressed(CalendarButton b, bool switchDisplayMode)
        {
            if (b.DataContext is DateTime)
            {
                ...
                switch (this.DisplayMode)
                {
                    ...
                    case CalendarMode.Decade:
                    {
                        newDate = DateTimeHelper.SetYear(this.DisplayDate, d);
            ...
            switch (this.DisplayMode)
            {
                case CalendarMode.Month:
                {
                    if (this.DisplayDate != null)
                    {
                        ...
                        DateTime? selectedDate = DateTimeHelper.DiscardDayTime(this.DisplayDateInternal);
                ...
                case CalendarMode.Year:
                {
                    ...
                    DateTime selectedMonth = DateTimeHelper.GetLastMonth(this.DisplayDate);
                    OnSelectedMonthChanged(selectedMonth);
                    break;
                }
                ...
                case CalendarMode.Decade:
                {
                    DateTime? selectedYear = DateTimeHelper.EndOfDecade(this.DisplayDate);
                    OnSelectedYearChanged(selectedYear);
                    break;
                }
            }
        ...
        private void ProcessHomeKey(bool shift)
        {
            switch (this.DisplayMode)
            {
                ...
                case CalendarMode.Year:
                {
                    ...
                    DateTime selectedMonth = DateTimeHelper.DiscardMonthDayTime(this.DisplayDate);
                    OnSelectedMonthChanged(selectedMonth);
                    break;
                }
                ...
                case CalendarMode.Decade:
                {
                    DateTime? selectedYear = DateTimeHelper.DecadeOfDate(this.DisplayDate);
                    OnSelectedYearChanged(selectedYear);
                    break;
                }
            }
